...
class EmailService:
    ...
    def send_rfp_email(self, rfp: RFP, vendor: Vendor, mail_instance=None) -> bool:
        """Send RFP to vendor via email"""
        try:
            mail_to_use = mail_instance or self.mail
            if not mail_to_use:
                print("Mail instance not available")
                return False
...
"""
    ...
    def _process_vendor_response(self, sender: str, subject: str, body: str) -> bool:
        ...
        try:
            ...
            # Create a simple parsed data structure for now
            parsed_data = {
                'total_price': 0,
